...
// routes
router.post("/cancel", authorize(), cancelReservation);
...
function reserveSeat(req, res, next) {
	movie_ticketService
		.reserveSeat(req.user.username, req.body.movie, req.body.seat)
...
function cancelReservation(req, res, next) {
	movie_ticketService
		.cancelReservation(req.user.username, req.body.movie, req.body.seat)
